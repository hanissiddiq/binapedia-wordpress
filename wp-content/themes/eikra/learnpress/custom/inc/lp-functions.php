...
function rdtheme_lp_wishlist_icon( $course_id ){
	...
	if ( !$user_id ) {
		echo '<div class="rt-wishlist-icon"><span data-toggle="modal" data-target="#rt-wishlist-modal" class="fas fa-heart" title="' . esc_attr__( 'Add this course to your wishlist', 'eikra' ) . '"></span></div>';
		return;
	}
