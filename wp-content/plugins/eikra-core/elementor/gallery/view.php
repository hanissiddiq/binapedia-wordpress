...
<div class="rt-gallery-1 rt-vc-isotope-container">
    ...
    <div class="row rt-vc-isotope-wrapper rt-gallery-wrapper rt-vc-magnific-popup">
        <?php foreach ( $gallery as $gallery_each ): ?>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 <?php echo esc_attr( $gallery_each['cats'] ); ?>">
                <div class="rt-gallery-box">
                    ...
                    <div class="rt-gallery-content">
                        <a href="<?php echo esc_url( $gallery_each['img_l'] );?>" class="rt-gallery-1-zoom" title="<?php echo esc_html( $gallery_each['title'] );?>"><i class="fas fa-link" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        <?php endforeach;?>
